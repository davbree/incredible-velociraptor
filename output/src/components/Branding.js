        ...
        return (
            <div className="site-branding">
              ...
              <p className="site-logo">
                <a href={safePrefix('/')}><img src={safePrefix(_.get(this.props, 'pageContext.site.siteMetadata.header.logo_img'))}
                    alt="Logo" /></a>
              </p>
              }
              {(_.get(this.props, 'pageContext.frontmatter.template') === 'home') ? 
              <h1 className="site-title"><a href={safePrefix('/')}>{_.get(this.props, 'pageContext.site.siteMetadata.header.title')}</a></h1>
               : 
              <p className="site-title"><a href={safePrefix('/')}>{_.get(this.props, 'pageContext.site.siteMetadata.header.title')}</a></p>
              }
